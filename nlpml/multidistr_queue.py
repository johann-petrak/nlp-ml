#!/usr/bin/env python
'''
Support for running jobs in multiprocessing (TODO: or even distributed processing) form.
This starts a number of producers, workers and consumers and passes the data from producers to workers and
ultimately to the consumers. This allows for fine-grained configuration of the number of producers, workers and
consumers to make sure that throughput is maximised.
'''
